...
async function main() {
  ...
  // To avoid overwhelming the JSON output token limits, we generate 4 batches of 10 items for each category
  // This will result in 40 items per category as requested!
  const BATCHES = 4;
